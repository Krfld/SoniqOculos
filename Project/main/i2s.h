...
#define SPEAKERS_WS_PIN 5
#define SPEAKERS_BCK_PIN 17
#define SPEAKERS_DATA_PIN 16
...
#define BONE_CONDUCTORS_WS_PIN 21
#define BONE_CONDUCTORS_BCK_PIN 19
#define BONE_CONDUCTORS_DATA_PIN 18
